...
/*void DatabaseManagement::inserData(Item item, int insert) {
...
void DatabaseManagement::selectPriority(int x)
{
    ...
    if (sqlite3_open("todolist.db", &db) == SQLITE_OK)
    {
        if (x == 1)
        {
            sqlite3_prepare( db, "SELECT * FROM TODO ORDER BY PRIORITY DESC;", -1, &stmt, nullptr );//preparing the statement
        } else if (x == 2)
        {
            sqlite3_prepare( db, "SELECT * FROM TODO ORDER BY PRIORITY ASC;", -1, &stmt, nullptr );//preparing the statement
        }
...
void DatabaseManagement::selectDate(int x)
{
    ...
    if (sqlite3_open("todolist.db", &db) == SQLITE_OK)
    {
        if (x == 1)
        {
            sqlite3_prepare( db, "SELECT * FROM TODO ORDER BY date(DUEDATE) DESC", -1, &stmt, nullptr );//preparing the statement
        } else if (x == 2)
        {
            sqlite3_prepare( db, "SELECT * FROM TODO ORDER BY date(DUEDATE) ASC", -1, &stmt, nullptr );//preparing the statement
        }
